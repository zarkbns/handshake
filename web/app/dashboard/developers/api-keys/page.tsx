      ...
      <div className="ds-section">
        ...
        <Panel>
          <p className="ds-section-note" style={{ margin: 0, lineHeight: 1.75 }}>
            Never place a settlement signer key in frontend code or a NEXT_PUBLIC_ variable —
            anything prefixed NEXT_PUBLIC_ is inlined into the browser bundle. The signer keys the
